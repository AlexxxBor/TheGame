...
namespace Weapon
{
    internal class BulletProjectorHelper
    {
        ...
        internal void CreateBulletHole(Vector3 point, Vector3 normal, Transform parent)
        {
            BulletProjectorData data =  _bulletHoles[UnityEngine.Random.Range(0, _bulletHoles.Length)];
        ...
        private Transform CreateHole(Vector3 point, Vector3 normal, Transform parent, BulletProjectorData data)
        {
            ...
            projector.transform.rotation = Quaternion.Euler(angles.x, angles.y, UnityEngine.Random.Range(0, 360));
